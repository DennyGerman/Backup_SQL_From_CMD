...
***Procedimiento de configuración de Copias de seguridad automáticas con eliminación después de 7 días***
...
Donde el valor "7" representa el número de días calendario. Por ejemplo, la línea anterior mantendrá las copias de seguridad durante un máximo de 15 días:
